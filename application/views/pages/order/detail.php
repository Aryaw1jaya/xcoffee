					...
					<table class="table table-bordered text-center">
						...
						<tbody>
							<?php foreach ($order_detail as $od) : ?>
								<tr>
									<td>
										<img src="<?= base_url('images/product/' . $od['image']) ?>" style="width:200px">
									</td>
									<td>
										<h5>Rp. <?= number_format($od['price']) ?></h5>
									</td>
								</tr>
							<?php endforeach ?>
						</tbody>
						<tfoot class="bg-success text-light">
							<tr>
								...
								<td>
									<h5><strong>Rp. <?= number_format(array_sum(array_column($order_detail, 'subtotal'))) ?></strong></h5>
								</td>
							</tr>
						</tfoot>
					</table>
			...
			<div class="col-8">
				<div class="card">
					...
					<div class="card-body">
						...
						<p>Nominal: <strong class="text-info">Rp. <?= number_format($order_confirm['nominal']) ?></strong></p>
